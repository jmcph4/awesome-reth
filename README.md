...
## Layer 2 ##
 ...
 - [Kakarot zkEVM](https://github.com/kkrt-labs), a zkEVM built in Cairo (provable by design) for which the [RPC](https://github.com/kkrt-labs/kakarot-rpc) is constructed using Reth.
